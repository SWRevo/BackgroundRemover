...
@Suppress("DEPRECATION", "RedundantVisibilityModifier")
internal class DrawView(c: Context?, attrs: AttributeSet?) : View(c, attrs) {
    ...
    private class AutomaticPixelClearingTask internal constructor(drawView: DrawView) : AsyncTask<Int?, Void?, Bitmap>() {
        ...
        override fun onPreExecute() {
            ...
            drawViewWeakReference.get()!!.cuts.push(Pair(null, drawViewWeakReference.get()!!.currentBitmap))
        }

        protected override fun doInBackground(vararg points: Int?): Bitmap {
